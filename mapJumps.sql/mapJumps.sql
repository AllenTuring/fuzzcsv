...
CREATE TABLE `mapJumps` (
  `stargateID` bigint(20) NOT NULL,
  `destinationID` bigint(20) DEFAULT NULL,
...
INSERT INTO `mapJumps` VALUES (50000001,50000482),(50000002,50000482);
...
-- Dump completed on 2016-03-09 17:03:44
